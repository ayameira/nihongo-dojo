...
A personalized Japanese language tutor powered by Google Gemini AI. Practice conversational Japanese with an AI sensei that adapts to your level, tracks your vocabulary from Anki, and remembers what you're working on.
...
- **AI-Powered Chat** — Streaming conversations with Gemini, optimized for Japanese immersion learning
...
Open `backend/.env` in your editor and set your Gemini API key:

```env
GEMINI_API_KEY=your_key_here
```

> 💡 **How to get a free API key:** Go to [Google AI Studio](https://aistudio.google.com/apikey), sign in with your Google account, and click "Create API Key". The free tier includes 15 requests/minute which is plenty for personal use.
...
| **AI** | Google Gemini (streaming + tool calling) |
| **Database** | SQLite |
...
│   │   ├── core/           # Gemini client, tools, context builder
